...
final class TimelineTest {
    ...
    private static void testTimeline(final Integer[] timeline,
        ...
        final TimeFeedbackAlgorithms.UpdateAgent<Integer, Integer> update =
                new TimeFeedbackAlgorithms.UpdateAgent<Integer, Integer>(timeline, v -> v == -1 || v == 0) {
                    @Override
        ...
        TimeFeedbackAlgorithms.updateTimeline(timeline, v -> v == 0, v -> v > 0 ? v : null, update);
