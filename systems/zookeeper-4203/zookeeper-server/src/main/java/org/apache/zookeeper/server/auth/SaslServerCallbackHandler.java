...
public class SaslServerCallbackHandler implements CallbackHandler {
    ...
    private static final String SYSPROP_SUPER_KEY = "zookeeper.SASLAuthenticationProvider.superPassword";
    ...
    private void handlePasswordCallback(PasswordCallback pc) {
        if ("super".equals(this.userName) && System.getProperty(SYSPROP_SUPER_KEY) != null) {
            // superuser: use Java system property for password, if available.
            pc.setPassword(System.getProperty(SYSPROP_SUPER_KEY).toCharArray());
